...
<head>
   ...
   <link rel="canonical" href="http://url.com.ar/">
   <meta property="og:image" content="http://url.com.ar/static/img/favicon/favicon-196x196.png">
   <meta property="og:image:secure_url" content="https://url.com.ar/static/img/favicon/favicon-196x196.png">
   ...
   <meta property="og:url" content="http://url.com.ar">
   <meta property="og:site_name" content="LV">
   <!-- ============== favicon ============== -->
   <!-- apple -->
   <link rel="apple-touch-icon" href="./static/img/favicon/apple-touch-icon-181x181.png">
   <!-- metro tile icon -->
   <meta name="msapplication-TileColor" content="#072D60">
   <meta name="msapplication-TileImage" content="./static/img/favicon/metro-tile-145x145.png">
   <!-- windows tile -->
   <meta name="application-name" content="La Verdad">
   <meta name="msapplication-tooltip" content="La Verdad, Noticias">
   <meta name="msapplication-config" content="./static/img/favicon/ieconfig.xml">
   <!-- web -->
   <link rel="icon" href="./static/img/favicon/favicon-32x32.png" sizes="32x32">
   <link rel="icon" type="image/png" href="./static/img/favicon/favicon-16x16.png" sizes="16x16">
   <!-- android -->
   <link rel="manifest" href="./static/img/favicon/site.webmanifest">
   <link rel="shortcut icon" sizes="196x196" href="./static/img/favicon/favicon-196x196.png">
   <!-- safari -->
